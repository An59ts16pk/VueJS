<template>
    ...
    <body>
        <header class="header center">
            <div class="header__menubar">
                <a class="header__logo" href="index.html">
                    <svg class="header__logoimg" width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <nav class="header__menu">
                    <ul class="header__menuList">
                        <li class="header__menuItem">
                            <a href="index.html" class="header__menuLink">Home</a>
                        </li>
                        <li class="header__menuItem">
                            <a href="#" class="header__menuLink">Project</a>
                        </li>
                        <li class="header__menuItem">
                            <a href="blog.html" class="header__menuLink">Blog</a>
                        </li>
                    </ul>
                </nav>
            </div>
        ...
        <footer class="footer center">
            ...
            <div class="footer__items">
                <div class="footer__logos">
                    ...
                    <div class="footer__icons">
                        <a href="#" class="footer__iconlink">
                            <svg class="footer__icon" width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="footer__contact">
                    ...
                    <p class="footer__address">55 East Birchwood Ave.<br> Brooklyn, New York 11201</p>
        ...
        <script src="scripts/blogdetails.js"></script> -->
    </body>
    </html>
</template>

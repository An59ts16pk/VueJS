    ...
    <footer class="footer center">
        ...
        <div class="footer__items">
            ...
            <div class="footer__menubar">
                ...
                <nav class="footer__menu">
                    <ul class="footer__menuList">
                        ...
                        <li class="footer__menuItem">
                            <router-link to="/project" class="footer__menuLink">Project</router-link>
                        </li>
                        <li class="footer__menuItem">
                            <router-link to="/blog" class="footer__menuLink">Blog</router-link>
                        </li>
                    </ul>
                </nav>
            </div>
            ...
            <div class="footer__contact">
                ...
                <router-link class="footer__email" to="#">contact@interno.com</router-link>
